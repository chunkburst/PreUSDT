      ...
      <a-card title="API设置">
        ...
        <a-form :model="form" :rules="rules" :layout="layoutMode" class="base-setting-form" @submit="onSubmit">
          ...
          <a-form-item
            ...
            label="收银台静态资源"
            extra="收银台模板与静态资源覆盖目录，用于自定义支付页 HTML/CSS/JS；首页模板请到「首页模板编辑」。请参考 docs/payment-template/README.md，修改后重启生效。"
          >
            <a-input v-model="form.payment_static_path" placeholder="/var/lib/preusdt/payment/" allow-clear />
          </a-form-item>

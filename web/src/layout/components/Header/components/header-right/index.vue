<template>
  <div class="header_setting" :class="isMobile && 'head-absolute-fix'">
    ...
    <a-tooltip content="主题设置">
      <a-button size="mini" type="text" class="icon_btn" id="theme-settings" @click="onThemeSetting">
        <template #icon>
          <icon-skin :size="18" />
        </template>
      </a-button>
    ...
    <a-dropdown trigger="hover">
      <div class="my_setting" id="system-my-setting">
        ...
        <span class="user-nickname">Hi {{ admin_username || "preusdt" }}</span>
        <div class="icon_down">
...
// 项目地址
const onProject = () => {
  window.open("https://github.com/chunkburst/PreUSDT", "_blank");
};
...
.header_setting {
  ...
  border-radius: 18px;
  box-shadow: 0 10px 24px rgba(17, 24, 39, 4%);
  ...
  > .icon_btn {
    ...
    &:hover {
      ...
      box-shadow: 0 10px 20px rgba(240, 185, 11, 12%);

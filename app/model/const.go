...
const (
	...
	PaymentMaxSwitchCount ConfKey = "payment_max_switch_count" // 订单支付方式最大切换次数
	HomepageTemplateHTML  ConfKey = "homepage_template_html"   // 首页模板 HTML
	HomepageTemplateCSS   ConfKey = "homepage_template_css"    // 首页模板 CSS
...
const (
	...
	WalletKindMulti  WalletKind = "multi"
)
const (
	WalletBaseGeneric WalletBase = "generic"
	WalletBaseEvm     WalletBase = "evm"
)

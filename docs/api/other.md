...
1. **Epusdt 兼容**：PreUSDT 与 Epusdt 插件保持高度兼容，理论上所有已适配 `Epusdt` 的程序均可无缝迁移至 `PreUSDT`
...
- [WooCommerce/WordPress 收款插件-PreUSDT for WooCommerce](https://github.com/immonsterx/bepusdt-woocommerce)

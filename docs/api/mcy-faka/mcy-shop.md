...
说回正题，萌次元并没对`epusdt`适配，但不影响，`PreUSDT`兼容易支付接口，同样可以顺利接入。
...
原版易支付不支持`usdt`和`trx`
，需有对原版代码进行替换；请把这个文件[Pay.php](https://raw.githubusercontent.com/chunkburst/preusdt/refs/heads/main/docs/mcy-shop/Pay.php)
